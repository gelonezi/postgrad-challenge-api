...
public class RejeitarOrdemDeServicoCommandHandlerTests
{
    ...
    private readonly RejeitarOrdemDeServicoCommandHandler _handler;

    public RejeitarOrdemDeServicoCommandHandlerTests()
    {
        _ordemServicoRepositoryMock = new Mock<IOrdemServicoRepository>();
        _unitOfWorkMock = new Mock<IUnitOfWork>();
        _metricsMock = new Mock<IOrdemDeServicoMetrics>();
        _handler = new RejeitarOrdemDeServicoCommandHandler(
    ...
    public async Task Handle_DeveRetornarBadRequest_QuandoOrdemNaoEstaEmAguardandoAprovacao()
    {
        ...
        var command = new RejeitarOrdemDeServicoCommand(ordemDeServico.Id);
    ...
    public async Task Handle_DeveRetornarNotFound_QuandoOrdemNaoExiste()
    {
        ...
        var command = new RejeitarOrdemDeServicoCommand(Guid.NewGuid());
